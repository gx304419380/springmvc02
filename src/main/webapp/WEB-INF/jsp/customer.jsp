		...
		<div id="page-wrapper">
			...
			<div class="panel panel-default">
				<div class="panel-body">
					<form class="form-inline" action="${pageContext.request.contextPath }/customer" method="get">
						...
						<div class="form-group">
							...
							<select	class="form-control" id="customerFrom" placeholder="客户来源" name="custSource">
								...
								<c:forEach items="${fromType}" var="item">
									<option value="${item.dictItemCode}"<c:if test="${item.dictItemCode == param.custSource}"> selected</c:if>>${item.dictItemName }</option>
								</c:forEach>
							</select>
						</div>
						<div class="form-group">
							...
							<select	class="form-control" id="custIndustry"  name="custIndustry">
								...
								<c:forEach items="${industryType}" var="item">
									<option value="${item.dictItemCode}"<c:if test="${item.dictItemCode == param.custIndustry}"> selected</c:if>>${item.dictItemName }</option>
								</c:forEach>
							</select>
						</div>
						<div class="form-group">
							...
							<select	class="form-control" id="custLevel" name="custLevel">
								...
								<c:forEach items="${levelType}" var="item">
									<option value="${item.dictItemCode}"<c:if test="${item.dictItemCode == param.custLevel}"> selected</c:if>>${item.dictItemName }</option>
								</c:forEach>
							</select>
						</div>
				...
				<div class="col-lg-12">
					<div class="panel panel-default">
						...
						<div class="col-md-12 text-right">
							<itcast:page url="${pageContext.request.contextPath }/customer" />
						</div>
						<!-- /.panel-body -->
					</div>
					<!-- /.panel -->
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select	class="form-control" id="edit_customerFrom" placeholder="客户来源" name="custSource">
									<option value="">--请选择--</option>
									<c:forEach items="${fromType}" var="item">
										<option value="${item.dictItemCode}"<c:if test="${item.dictItemCode == custSource}"> selected</c:if>>${item.dictItemName }</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10"> 
								<select	class="form-control" id="edit_custIndustry"  name="custIndustry">
									<option value="">--请选择--</option>
									<c:forEach items="${industryType}" var="item">
										<option value="${item.dictItemCode}"<c:if test="${item.dictItemCode == custIndustry}"> selected</c:if>>${item.dictItemName }</option>
									</c:forEach>
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select	class="form-control" id="edit_custLevel" name="custLevel">
									<option value="">--请选择--</option>
									<c:forEach items="${levelType}" var="item">
										<option value="${item.dictItemCode}"<c:if test="${item.dictItemCode == custLevel}"> selected</c:if>>${item.dictItemName }</option>
									</c:forEach>
								</select>
							</div>
						</div>
